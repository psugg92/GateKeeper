...
//                 <button type="button" className="btn btn-light" data-toggle="modal" data-target="#locationCreation">
//                     Create New Location
//                 </button>

//                 {/* <!-- Modal 2 --> */}
//                 <div className="modal" id="locationCreation" tabIndex="-1" role="dialog" aria-labelledby="upload-avatar-title" aria-hidden="true">
